// To parse this data:
//
//   import { Convert, GhipyResponse } from "./file";
//
//   const ghipyResponse = Convert.toGhipyResponse(json);
//
...
export class Convert {
  public static toGhipyResponse(json: string): GiphyResponse {
    return cast(JSON.parse(json), r("GhipyResponse"));
  }

  public static ghipyResponseToJson(value: GiphyResponse): string {
    return JSON.stringify(uncast(value, r("GhipyResponse")), null, 2);
  }
}
...
const typeMap: any = {
  "GhipyResponse": o([
    { json: "data", js: "data", typ: a(r("GhipyItem")) },
